...
$(function () {
    var a = $("#settings"), b = $("#sidebar-settings"), c = JSON.parse(localStorage.getItem("settings-state")) || {
        ...
        c = void 0 == c ? !0 : !1, d[0] && (b.html(_.template(d.html())({sidebarState: a})), "auto" == a ? $(".sidebar, .side-nav, .wrap, .logo").removeClass("sidebar-icons") : $(".sidebar, .side-nav, .wrap, .logo").addClass("sidebar-icons"), c && triggerChartsResize())
    }, j = function (a, b) {
